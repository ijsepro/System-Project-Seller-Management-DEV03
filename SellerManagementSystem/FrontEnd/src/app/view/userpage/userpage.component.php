...
<head>
  ...
  <link rel="stylesheet" href="userpage.component.scss">
...
<div class="container-fluid">
  ...
  <div class="row">
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 logo text-center">
      <p class="btn btn-primary right"><a href="../../../../../BackEnd/application/views/login.php">Logout</a></p>
  ...
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 editor event">
      ...
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 editor event">
        ...
        <div class="collapsediv5 team collapse out">
          ...
          <table border="0" width="95%" height="95%" align="center">
            <form action="../../../../../BackEnd/application/controllers/updateuser.php" method="POST">
              <tr>
                <td>
                  <p>GRN id</p>
                </td>
      ...
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 editor event">
        ...
        <div class="collapsediv7 team collapse out">
          ...
          <table border="0" width="95%" height="95%" align="center">
            <form action="../../../../../BackEnd/application/controllers/jobpost.php" method="POST">
